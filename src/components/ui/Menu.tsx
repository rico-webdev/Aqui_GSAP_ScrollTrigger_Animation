...
import { menuSections } from "@/constants/constants";
  ...
  return (
    <div className="relative">
      <section
        ref={container}
        id="menu"
        className="container flex flex-col mx-auto relative z-10 min-h-dvh px-10 pb-[320px] md:px-0 md:pb-20 ">
        <h2
          id="menu-heading"
        ...
        <div className="col-center md:flex-row gap-20 justify-between mx-10">
          {menuSections.map((section) => (
            <div key={section.id} className="relative col-center w-[245px] ">
              <h3
                id="list-title"
                className="text-neutral-500 text-7xl capitalize font-dancing-script mb-8 md:-mb-5">
                {section.title}
              </h3>
